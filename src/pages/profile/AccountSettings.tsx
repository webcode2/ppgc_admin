...
import { Mail, Lock, ShieldCheck, Save, Power } from "lucide-react";
                ...
                <div className="flex gap-2 p-4 justify-between px-10">
                    <div className="input w-6/12">
                        <input
                            ...
                            className="flex-1 px-3 py-2 border w-full rounded-lg 
                            focus:outline-none focus:ring-2 focus:ring-[#938E07]"
                        />
                    </div>
                    ...
                    <button
                        ...
                        bg-gradient-to-r from-[#F9F10C] to-[#938E07] 
                        text-black font-semibold rounded-lg shadow-sm hover:opacity-90"
                    >
            ...
            <div className="border rounded-xl p-4 py-10">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button
                        ...
                        transition-all active:scale-95 rounded-lg flex items-center gap-1"
                    >
