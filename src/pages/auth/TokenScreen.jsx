...
import { loginAccount } from "../../store/slice/authSlice";
    ...
    return (
        <div className="min-h-screen flex">
            <div className="w-6/12 bg-white z-40 flex flex-col items-center justify-center p-8">
                <TokenInput />
                <div className="countdown text-lg font-semibold my-4">
                    code expires in &nbsp;
                ...
                <button
                    ...
                    className="w-6/12 text-white cursor-pointer mt-4 font-semibold py-3 px-4 rounded-full bg-[linear-gradient(0deg,#938E07,#F9F10C)] active:scale-95 transition-transform duration-200 focus:ring-opacity-50"
                >
                    Verify
                </button>
